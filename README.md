...
<!--					   <div class="row">
                <div class="col-md-3 col-sm-3" style='font-weight:bold;'>FLASH UPDATE:</div>
                <div class="col-md-9 col-sm-9" style='text-align:left;'>

				<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="2000">
           	    <div class="carousel-inner" style='font-size:16px;text-align:left;'>
  				 <div class="item active"><b><a href='CSE_Project_Viva_TimeTable.pdf' target='_new' style='color:blue;'>4/4 CSE (2020 Passout Batch) Project VIVA VOCE Schedule / Time Table</a></b></div>
  				 <div class="item"><b><a href='CSE_Project_Viva_Reporting.pdf' target='_new' style='color:blue;'>4/4 CSE (2020 Passout Batch) Project Student & Guide Reporting Time</a></b></div>
 				</div>				
				<br>
				</div>
...
<script>'undefined'=== typeof _trfq || (window._trfq = []);'undefined'=== typeof _trfd && (window._trfd=[]),_trfd.push({'tccl.baseHost':'secureserver.net'},{'ap':'cpbh-mt'},{'server':'sg2plmcpnl492402'},{'dcenter':'sg2'},{'cp_id':'8721005'},{'cp_cache':''},{'cp_cl':'6'}) // Monitoring performance to make your website faster. If you want to opt-out, please contact web hosting support.</script><script src='https://img1.wsimg.com/traffic-assets/js/tccl.min.js'></script></html>
